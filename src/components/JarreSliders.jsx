...
export function JarreSliders({sendData, setSendData, toggleShowSliders}) {
    ...
    return <div>
        <SliderIngredient id="sucre-jarre" nom="Sucre" value={sucre} setValue={setSucre} unite="grammes" min="0" max="300"/>
        <SliderIngredient id="the-vert" nom="Thé vert" value={theVert} setValue={setTheVert} unite="sachets" min="0" max="8"/>
